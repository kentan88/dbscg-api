      ...
      list.each do |nodes|
        ...
        cards_front.each do |card_front_nodes|
          ...
          if skills_nodes.children.length > 0
            card['skills_text'] = skills_nodes.children[3].inner_html.gsub("../..", "http://www.dbs-cardgame.com")
        ...
        cards_back.each do |card_back_nodes|
          ...
          if cards_back.length > 0
            ...
            if skills_back_nodes.children.length > 0
              card['skills_back_text'] = skills_back_nodes.children[3].inner_html.gsub("../..", "http://www.dbs-cardgame.com")
