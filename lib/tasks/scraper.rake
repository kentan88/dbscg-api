      ...
      list.each do |nodes|
        ...
        cards_front.each do |card_front_nodes|
          ...
          if energy_nodes.children.length > 0
            ...
            card['energy_text'] = energy_inner_html.gsub("../../images/cardlist/common/", "/images/common/")
          end
          ...
          if skills_nodes.children.length > 0
            card['skills_text'] = skills_nodes.children[3].inner_html.strip.gsub("../../images/cardlist/common/", "/images/common/")
        ...
        cards_back.each do |card_back_nodes|
          ...
          if cards_back.length > 0
            ...
            if skills_back_nodes.children.length > 0
              ...
              card['skills_back_text'] = skills_back_nodes.children[3].inner_html.strip.gsub("../../images/cardlist/common/", "/images/common/")
